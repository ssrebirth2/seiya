...
export default function HeroEquipmentRow({
  ...
  return (
    <div className="p-0 border border-panel-border rounded bg-panel flex flex-col gap-2 relative overflow-hidden">
      {/* 🔹 Fundo do herói */}
      ...
      <div className="relative z-10 w-full min-h-[190px] flex items-center">
        ...
        <div className="hidden md:grid grid-cols-[150px_1fr_auto] items-end gap-0 w-full">
          ...
          <div className="flex justify-end pb-0">
            ...
            >
              <div className="w-20 h-20 border border-panel-border bg-panel-hover rounded-full flex items-center justify-center overflow-hidden">
                {equipment.artifact ? (
                  <img
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {Array.from({ length: 5 }).map((_, i) => (
              <div
                key={i}
                className={`border border-panel-border bg-panel-hover flex items-center justify-center relative cursor-pointer
        ...
        <div className="flex flex-col md:hidden items-center justify-center p-3 gap-3 relative w-full">
          ...
          <div className="absolute top-3 right-3 z-10">
            ...
            >
              <div className="w-16 h-16 border border-panel-border bg-panel-hover rounded-full flex items-center justify-center overflow-hidden shadow-md">
                {equipment.artifact ? (
                  <img
                    src={`/assets/resources/textures/artifact/artifactskill/skillicon/SkillIcon_${equipment.artifact}00.png`}
                    alt="Artifact"
      ...
      {!readOnly && popupType && (
        <div
          className="fixed inset-0 z-[100] flex items-center justify-center overlay-backdrop-strong backdrop-blur-sm"
          ref={popupRef}
        >
          <div className="bg-panel border border-panel-border rounded-lg shadow-2xl p-4 w-[480px] max-h-[80vh] overflow-y-auto relative">
            <button
