    ...
    <div className="flex flex-wrap gap-6 items-end rounded-xl p-4 bg-panel-hover">
      ...
      <div>
        ...
        <input
          ...
          className="w-24 h-10 rounded-xl px-4 bg-panel border border-panel-border text-center font-semibold"
        />
      </div>
    </div>
  )
        ...
        <tbody>
          {stats.map((attr, idx) => (
            <tr
              ...
              } hover:bg-panel-hover/80`}
            >
              <td className="px-2 py-2">{getT(attr.name)}</td>
              <td className="px-2 py-2 text-right text-text-muted">{attr.base}</td>
              <td className="px-2 py-2 text-right font-semibold">+{attr.starValue}</td>
              <td className="px-2 py-2 text-right font-bold text-accent">{attr.total}</td>
            </tr>
          ))}
        </tbody>
      </table>
