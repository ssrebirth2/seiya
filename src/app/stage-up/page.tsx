...
import StageUpClient from './stage-up-client'
...
export async function generateMetadata({ searchParams }: PageProps): Promise<Metadata> {
  ...
  const meta = await fetchSectionMetadata('stage-up', lang)
  const path = buildShareUrl('/stage-up', lang)
  return buildEntityMetadata(meta, lang, path)
}

export default function StageUpPage() {
  return <StageUpClient />
}
